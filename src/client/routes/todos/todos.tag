  ...
  script.
    ...
    @on "mount", ->
      @root.querySelector("form").addEventListener "submit", (event) =>
        ...
        @store.dispatch @actions.todos.add @root.querySelector("input").value
visible_todo_list
  ul
  ...
  script.
    ...
    @onClick = (id) => @store.dispatch @actions.todos.toggle id
todo
...
filter_link
  ...
  script.
    ...
    @onClick = => @store.dispatch @actions.todos.setFilter opts.filter